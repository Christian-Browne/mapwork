...
class App {
  ...
  //Constrcutor calls these methods right away
  constructor() {
    this._getPosition();
  ...
  _loadMap(position) {
    ...
    // Shows map after browser recieves/gets coordinates
  ...
  _newWorkout(e) {
    ...
    // TODO: If running create running obj
    if (type === 'running') {
    ...
    // TODO: If cycling create cycling obj
    if (type === 'cycling') {
    ...
    // TODO: render workout on map as a marker
